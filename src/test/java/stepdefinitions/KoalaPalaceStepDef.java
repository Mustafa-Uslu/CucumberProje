...
public class KoalaPalaceStepDef {
    ...
    //http://www.kaolapalace-qa-environment2.com/admin/HotelRoomAdmin
    //JavascriptExecutor jsExecutor =((JavascriptExecutor)Driver.getDriver());
    //jsExecutor.executeScript("arguments[0].click();",page.hotelListSearchButonu );
    ...
    public void kullanici_hoteledit_yazisini_dogrular(String string) {
        ...
        // istenilen yazi cikincaya kadar bekler textToBe,
        Assert.assertTrue(yaziDogruMu);
    }
        // http://www.kaolapalace-qa-environment2.com/admin/HotelRoomAdmin/Edit?Id=472
        // http://www.kaolapalace-qa-environment2.com/admin/HotelRoomAdmin/Edit?Id=13
